...
const Index = () => {
  ...
  const jsonLd = useMemo(
    () => ({
      ...
      url: siteUrl,
      logo: `${siteUrl}hero-architecture.jpg`,
      foundingDate: "2006",
      areaServed: [
        {
          "@type": "City",
