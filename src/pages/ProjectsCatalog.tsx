      ...
      <div className="container mx-auto px-6 py-12 pt-24">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground/70 mt-3 italic max-w-3xl">
            Проектов очень много. Здесь представлены некоторые из них. Готов подобрать вам готовый проект со скидкой или запроектировать индивидуальный под ваши требования.
          </p>
        </div>
