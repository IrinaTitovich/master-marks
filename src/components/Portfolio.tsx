  ...
  const projects = [
    {
      ...
      description: "Современный дом с чистыми линиями и функциональной планировкой",
      area: "250 м²",
    },
    {
      image: project2,
      ...
      area: "320 м²",
      description: "Просторный семейный дом с большими окнами и открытой планировкой",
    },
    {
      image: project3,
      title: "Люкс вилла",
      description: "Премиальный дом с бассейном и панорамным остеклением",
      area: "450 м²",
    },
  ];
